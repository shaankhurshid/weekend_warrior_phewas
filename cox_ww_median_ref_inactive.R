...
# Set levels
ww[,activity_group_median := factor(activity_group_median,levels=c('Inactive','Active - WW','Active - Regular'))]
...
# Save out
write.csv(out,file='cox_ww_ref_inactive.csv',row.names=F)